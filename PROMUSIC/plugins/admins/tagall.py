...
TAGMES = [ " **𝐇𝐞𝐲 𝐂𝐨𝐨𝐥 𝐀𝐧𝐠𝐞𝐥 𝐊𝐚𝐡𝐚 𝐇𝐨🤗🥱** ",
           ...
           " **𝐘𝐚𝐡𝐚 𝐀𝐚 𝐉𝐚𝐨:[@TEAM_BADNAM_BOTS ] 𝐌𝐚𝐬𝐭𝐢 𝐊𝐚𝐫𝐞𝐧𝐠𝐞 🤭🤭** ",
           " **𝐓𝐫𝐮𝐭𝐡 𝐀𝐧𝐝 𝐃𝐚𝐫𝐞 𝐊𝐡𝐞𝐥𝐨𝐠𝐞..? 😊** ",
           " **𝐀𝐚𝐣 𝐌𝐮𝐦𝐦𝐲 𝐍𝐞 𝐃𝐚𝐭𝐚 𝐘𝐫🥺🥺** ",
           " **𝐉𝐨𝐢𝐧 𝐊𝐚𝐫 𝐋𝐨:- [ @YASH_ABOUT_XD_lll ] 🤗** ",
           " **𝐆𝐚𝐥𝐢 𝐬𝐮𝐧 𝐧𝐚 𝐡𝐚𝐢 𝐃𝐨 𝐨𝐫 𝐃𝐢𝐞 𝐤𝐞 𝐩𝐚𝐬𝐬 𝐣𝐚𝐨😗😗** ",
           " **𝐓𝐮𝐦𝐡𝐚𝐫𝐞 𝐃𝐨𝐬𝐭 𝐊𝐚𝐡𝐚 𝐆𝐲𝐞🥺** ",
           " **𝐌𝐲 𝐂𝐮𝐭𝐞 𝐎𝐰𝐧𝐞𝐫 [  @BADNAM_BABY_lll_YADAV]🥰** ",
           " **𝐊𝐚𝐡𝐚 𝐊𝐡𝐨𝐲𝐞 𝐇𝐨 𝐑𝐮𝐩𝐚𝐤 maya darling  𝐠😜** ",
...
async def cancel_spam(client, message):
    ...
    if not is_admin:
        ...
        try:
            ...
            pass
        return await message.reply("♦ BADNAM sᴛᴏᴘᴘᴇᴅ ᴛᴀɢɪɴɢ...♦")
